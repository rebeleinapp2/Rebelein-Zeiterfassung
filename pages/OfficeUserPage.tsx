                                ...
                                <SpotlightCard key={req.id} className="bg-background border border-border p-4 rounded-xl shadow-sm hover:shadow-md hover:border-purple-500/50 transition-all flex flex-col gap-3 group">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto">
                                        {canManage ? (
                                            <>
                                                <button
                                                    onClick={() => generateVacationRequestPDF(req, currentUser, requests, viewerSettings)}
                                                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded-lg hover:bg-blue-500/20 font-bold text-xs transition-colors"
                                                >
                                ...
                                <div className="space-y-2 max-h-40 overflow-y-auto scrollbar-thin">
                                    {approvedRequests.map(req => (
                                        <div key={req.id} className="bg-emerald-500/5 p-3 rounded-xl border border-emerald-500/10 flex items-center justify-between gap-2">
                                            ...
                                            <button
                                                onClick={() => generateVacationRequestPDF(req, currentUser, requests, viewerSettings, true)}
